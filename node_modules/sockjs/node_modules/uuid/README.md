...
cd ***REMOVED***chmark/
npm install
node ***REMOVED***chmark.js
```

For a more complete discussion of uuid performance, please see the `***REMOVED***chmark/README.md` file, and the [***REMOVED***chmark wiki](https://github.com/broofa/uuid/wiki/***REMOVED***chmark)
