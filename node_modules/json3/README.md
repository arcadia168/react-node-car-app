...
The JSON 3 parser does **not** use `eval` or regular expressions. This provides security and performance ***REMOVED***efits in obsolete and mobile environments, where the margin is particularly significant. The complete [***REMOVED***chmark suite](http://jsperf.com/json3) is available on [jsPerf](http://jsperf.com/).
