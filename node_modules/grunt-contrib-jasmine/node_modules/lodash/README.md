# Lo-Dash v2.4.2
A utility library delivering consistency, [customization](https://lodash.com/custom-builds), [performance](https://lodash.com/***REMOVED***chmarks), & [extras](https://lodash.com/#features).
...
There’s plenty of **[documentation](https://lodash.com/docs)**, [unit tests](https://lodash.com/tests), & [***REMOVED***chmarks](https://lodash.com/***REMOVED***chmarks).<br>
